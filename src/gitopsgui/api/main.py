...
from .routers import clusters, applications, application_configs, pipelines, prs, repositories, status, forges, repos, sops_keys, ingress, hypervisors, instances
...
app.include_router(ingress.router, prefix="/api/v1")
app.include_router(hypervisors.router, prefix="/api/v1")
