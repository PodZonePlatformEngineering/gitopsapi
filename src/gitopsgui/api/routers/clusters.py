...
async def list_clusters(_=Depends(require_role("cluster_operator", "build_manager", "senior_developer"))):
    svc = ClusterService()
...
async def get_kubeconfig(name: str, caller=Depends(require_role("cluster_operator", "build_manager", "senior_developer"))):
